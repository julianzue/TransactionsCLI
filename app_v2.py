...
def show_list():
    ...
    for index, line in enumerate(data, 1):
        ...
        print(f"{c}{'{:03d}'.format(index)}{re} {line["Buchungstag"]} {color}{'{:10,.2f}'.format(float(line["Betrag"].replace(",", ".")))}{re} {line["Waehrung"]} {dim}{g}{"{:<22}".format(line["Kontonummer/IBAN"])}{re} {line["Verwendungszweck"]}{res} {b}{dim}({line["Beguenstigter/Zahlungspflichtiger"]}){res}")
...
def show_list_in():
    ...
    for index, line in enumerate(data, 1):
        ...
        if float(line["Betrag"].replace(",", ".")) >= 0:
            ...
            print(f"{c}{'{:03d}'.format(counter)} {dim}{'{:03d}'.format(index)}{res} {line["Buchungstag"]} {color}{'{:10,.2f}'.format(float(line["Betrag"].replace(",", ".")))}{re} {line["Waehrung"]} {dim}{g}{"{:<22}".format(line["Kontonummer/IBAN"])}{re} {line["Verwendungszweck"]}{res} {b}{dim}({line["Beguenstigter/Zahlungspflichtiger"]}){res}")
